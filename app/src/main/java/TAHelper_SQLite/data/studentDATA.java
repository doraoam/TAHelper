...
public class studentDATA {
    ...
    public long addNewStudent(String StudentID, String Name, String Surname, String Major, String Faculty){
    ...
    public Cursor readAllStudent(){
        Cursor mCursor = database.query(true,STUDENT_TABLE, new String[]{
                COLUMN_ID,COLUMN_STUDENTID,COLUMN_NAME,COLUMN_SURNAME,COLUMN_MAJOR,COLUMN_FACULTY},null,
    ...
    public int updateStudent(String id,String StudentID, String Name, String Surname, String Major, String Faculty){
        ContentValues values = new ContentValues();
